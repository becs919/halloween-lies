var characters = [{name: 'Abe',
 ...
 {name: 'Andrew',
  ...
  desc : 'Les is a mesmerist whose clients have included Charlie Henderson-Plum and  Cutter.',
  code: '!ekcGI*63ODb'},
 {name: 'Lauren',
 ...
 {name: 'Emily',
  ...
  code: '4UdZ85r$0*Q5'},
 {name: 'Teresa',
  email: 'teresa07moreno@gmail.com',
 ...
 {name: 'Bebe',
  ...
  code: 'gYaRZ225@TOm'},
 {name: 'Kelly',
  email: 'knowlesnotbeyonce@gmail.com',
  character_name: 'Pip Slater',
  desc : 'Pip is one of Hollywood’s many agents and is looking to sign up more clients tonight.',
  code: 'p1yGBeye3Q*k'},
  {name: 'Chris',
   email: 'cdbowen603@gmail.com',
   character_name: 'Sam Cortinelli',
   desc : "Sam Cortinelli is one of The Vampire Detective’s stunt doubles. Sam is rumored to have 'family' connections.",
   code: 'p1yGH6kvd4*k'},
 {name: 'Corin',
  email: 'corin.vallee@gmail.com',
  character_name: 'Luca Delmonico',
  desc : 'Luca comes from a very wealthy family and recently appeared in the movie The Sound of Screams.',
  code: 'riv74wcfkb9'},
  {name: 'Zach',
   email: 'speedykrieger@msn.com',
   character_name: 'Claude Janvier',
   desc : 'Claude is a composer who recently wrote the music for Ash d’Lessey’s Blood Red.',
   code: 'Frg6ksg&*9'},
   {name: 'Ayla',
    email: 'aylalevey@gmail.com',
    character_name: 'Shelly Wells',
    desc : 'Shelly owns TrixieCorp, a large corporation that makes fast food and frozen dinners (amongst other things), but is now producing a movie.',
    code: 'ijc#nfiHFt'},
    {name: 'Adam',
     email: 'ajleveytfw@gmail.com',
     character_name: 'Max McNab',
     desc : 'Max plays bits & parts and is struggling to get into the big time. In The Vampire Detective Max played “Cop in Elevator”.',
     code: 'whGi5027*g33r'},
     {name: 'Haley',
      email: 'haley9670@gmail.com',
      character_name: 'Jackie Simpson',
      desc : 'Jackie was originally signed up to act in The Vampire Detective, but was fired before filming started after Jackie and Tom Speed had a blazing row.',
      code: '6*?sfkHYSFwf4'}]
